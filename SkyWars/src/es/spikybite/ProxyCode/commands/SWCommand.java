...
public class SWCommand implements CommandExecutor{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label,
		...
		if(cmd.getName().equalsIgnoreCase("stats")){
			...
			p.sendMessage("§7--------- §bEstadisticas §7----------");
			p.sendMessage("§7Bajas: §a"+player.getKills());
			p.sendMessage("§7Muertes: §a"+player.getDeaths());
			p.sendMessage("§7Bloques Destruidos: §a"+player.getBlockBreaks());
			p.sendMessage("§7Bloques Insertados: §a"+player.getBlockPlaceds());
			p.sendMessage("§7Partidas Jugadas: §a"+player.getGames());
			p.sendMessage("§7Victorias: §a"+player.getWins());
			p.sendMessage("§7Disparos: §a"+player.getShots());
			p.sendMessage("§7Distancias Recorridas: §a"+player.getWalked());
			p.sendMessage("§7Crisral: §a"+player.getGlass());
			p.sendMessage("§7Flechas: §a"+player.getTrail());
			p.sendMessage("§7--------------------------");
		}
